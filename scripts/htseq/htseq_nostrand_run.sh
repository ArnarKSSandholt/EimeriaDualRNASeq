...
do
    ...
    htseq-count -f bam -r pos -s no -i gene ${f}_Aligned.sortedByCoord.out.bam results/star/merged_reference/eimeria_chicken_merge.gff \
        > results/htseq/${GROUP_NAME}/${OUTPUT_NAME}.counts